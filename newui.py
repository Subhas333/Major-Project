...
class VideoThread(QThread):
    ...
    def stop(self):
        #fixme:Stop the thread and release resources
        self.running = False
        self.quit()
        self.wait()
...
class GestureControlApp(QMainWindow):
    ...
    def __init__(self):
        ...
        #fixme: Initial blank state or loading message
        self.label = QLabel("Waiting for 'start' command...")
        ...
        # fixme:Connecting  the signals that start the camera and exit
    ...
    def start_camera(self):
        #todo:Start the camera thread and update the UI 
    ...
    def exit_application(self):
        #fixme:close the program the exit button click or voice
